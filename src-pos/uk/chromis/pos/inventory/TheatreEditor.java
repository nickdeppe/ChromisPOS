 ...
 * @author  adrian
 */
public final class TheatreEditor extends javax.swing.JPanel implements EditorRecord {

    private Object id;
        
    /** Creates new form AttributesEditor
     * @param dirty */
    public TheatreEditor(DirtyManager dirty) {
        initComponents();
        ...
        m_jCapacityMode.addItem("By Ticket Count");
        m_jCapacityMode.addItem("By Transaction Count");
    ...
    public void writeValueEOF() {
        ...
        m_jCapacityMode.setSelectedIndex(0);
    ...
    public void writeValueDelete(Object value) {
        ...
        m_jCapacityMode.setSelectedIndex(0); // TODO
