...
//            tf.addActionListener(dirty);
    ...
    public void writeValueEOF() {
        ...
        m_jExtraDescription.setText(null);
        ...
        m_jExtraDescription.setEnabled(false);
    ...
    public void writeValueInsert() {
        ...
        m_jExtraDescription.setEnabled(true);
    ...
    public void writeValueDelete(Object value) {
        ...
        m_jExtraDescription.setText(Formats.STRING.formatValue(theatre[2]));
        capacityModeModel.setSelectedKey(theatre[3]);
        m_jCapacity.setValue(Formats.INT.formatValue(theatre[4]));
        m_jHardLimit.setSelected( (Boolean) theatre[5] );
        m_jActive.setSelected( (Boolean) theatre[6] );
    ...
    public void writeValueEdit(Object value) {
        ...
        m_jExtraDescription.setText(Formats.STRING.formatValue(theatre[2]));
        capacityModeModel.setSelectedKey(theatre[3]);
        m_jCapacity.setValue(theatre[4]);
        m_jHardLimit.setSelected( (Boolean) theatre[5] );
        m_jActive.setSelected( (Boolean) theatre[6] );
    ...
    public Object createValue() throws BasicException {
        ...
        Object[] theatre = new Object[7];

        theatre[0] = id;
        theatre[1] = m_jName.getText();
        theatre[2] = m_jExtraDescription.getText();
        theatre[3] = capacityModeModel.getSelectedKey();
        theatre[4] = m_jCapacity.getValue();
        theatre[5] = m_jHardLimit.isSelected();
        theatre[6] = m_jActive.isSelected();
    ...
    private void initComponents() {
        ...
        m_jExtraDescription = new javax.swing.JTextField();
        ...
        jLabel5.setText(AppLocal.getIntString("Label.ExtraDescription")); // NOI18N

        m_jExtraDescription.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(134, 134, 134))
                            .addComponent(m_jCapacityMode, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(m_jExtraDescription, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(m_jExtraDescription, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
