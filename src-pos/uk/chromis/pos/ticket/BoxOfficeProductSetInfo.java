 ...
 * @version
 */
public class BoxOfficeProductSetInfo implements IKeyed {
    ...
    /**
     * Creates new BoxOfficeProductSetInfo
     *
    * @param id
    * @param name
    * @param active
     */
    public BoxOfficeProductSetInfo(String id, String name, Boolean active ) {
        m_sID = id;
        m_sName = name;
        m_bActive = active;
    }
    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() {
            ...
            public Object readValues(DataRead dr) throws BasicException {
                return new BoxOfficeProductSetInfo(dr.getString(1), dr.getString(2), dr.getBoolean(3));
            }
        };
    }
}
