    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() {
            ...
            public Object readValues(DataRead dr) throws BasicException {
                return new ShowScheduleInfo(dr.getString(1), dr.getString(2), dr.getString(3), dr.getTimestamp(4), dr.getTimestamp(5), dr.getTimestamp(6), dr.getTimestamp(7), dr.getDouble(8) );
            }
        };
    }
