...
public class ProductFilterReportWithCat extends javax.swing.JPanel implements ReportEditorCreator {
    ...
    public SerializerWrite getSerializerWrite() {
        return new SerializerWriteBasic(
                new Datas[]{Datas.OBJECT, Datas.STRING, Datas.OBJECT, Datas.DOUBLE, Datas.OBJECT, Datas.DOUBLE, Datas.OBJECT, Datas.STRING, Datas.OBJECT, Datas.STRING, Datas.OBJECT, Datas.BOOLEAN});
    }
    ...
    public Object createValue() throws BasicException {
        ...
        if (m_jBarcode.getText() == null || m_jBarcode.getText().equals("")) {
            ...
            return new Object[]{
                ...
                m_jIcatalogue.getSelectedItem() == null ? QBFCompareEnum.COMP_NONE : QBFCompareEnum.COMP_EQUALS, bVal, null
